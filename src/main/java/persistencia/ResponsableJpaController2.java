 ...
 * @author jonii
 */
public class ResponsableJpaController2 implements Serializable {

    public ResponsableJpaController2(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public EntityManager getEntityManager() {
     ...
     public ResponsableJpaController2() {
